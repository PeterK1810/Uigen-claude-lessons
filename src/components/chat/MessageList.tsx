...
export function MessageList({ messages, isLoading }: MessageListProps) {
  if (messages.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center min-h-full flex-1 px-4 text-center">
                      ...
                      {message.parts.map((part, partIndex) => {
                        switch (part.type) {
                          ...
                          case "tool-invocation":
                            return <ToolCallStatus key={partIndex} toolInvocation={part.toolInvocation} />;
                          case "source":
                            return (
